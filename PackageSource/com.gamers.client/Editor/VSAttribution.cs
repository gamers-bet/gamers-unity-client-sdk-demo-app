...
// Unity's Verified Solutions attribution script from
// https://github.com/Unity-Technologies/com.unity.vs-attribution with the
// namespace changed and public XML documentation expanded.
namespace Gamers.Client.Editor
{
	/// <summary>Sends Verified Solutions attribution through Unity Editor Analytics.</summary>
	/// <remarks>This Editor-only implementation is not included in player builds.</remarks>
	public static class VSAttribution
	{
		...
		/// <returns>The Unity Editor Analytics result, or <see cref="AnalyticsResult.AnalyticsDisabled"/> when analytics is disabled or sending fails.</returns>
