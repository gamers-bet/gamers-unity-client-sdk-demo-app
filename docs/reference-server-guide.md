...
Source: `sdks/reference-server`. Companion documents: [Developer Guide](https://developer.gamers.dev/docs/dev-guide) · [Unity Client SDK Guide](https://developer.gamers.dev/docs/client-sdk-guide) · [Server SDK Guide](https://developer.gamers.dev/docs/server-sdk-guide)
